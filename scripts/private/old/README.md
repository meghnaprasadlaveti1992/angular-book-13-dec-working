...
folder `angular-bookcat-snapshots`, which then contains an additional folder called `sandbox`.
...
- **snaphot.sh**: Run this script to generate the `angular-bookcat-snapshots` folder, containing
...
The book data used by the application is scraped from a Google search page.

- ScrapeData.js: Run this script using node.js to access the web page containing the book data and
  copy the data into the `app/books` folder.
